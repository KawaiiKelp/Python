...
# 4명이 넘으면 추가비용이 1인당 만원 8명이 넘으면 최대 입장인원은 8명 입니다
...
if total <= 4:
    ...
    print(("추가비용 1인당 {0}만원입니다").format(total-4))
else:
...
print(round(5.7777, 0)) # 6.0
print(round(5.7777)) # 6
...
print("{1:.2f}과 {0:.3f}".format(3.5555, 3.7777))
 """""" 
...
if len(scores) > 0:
    ...
    print("평균 점수: {:.2f}점".format(avg_score))
else:
    print("입력된 점수가 없습니다")
 """
# 점수에 따른 학점 판단
